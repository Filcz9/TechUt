...
public class ComputerGameManagerTest {
	...
	private final static String Release_1 = new Date();
	...
	private final static Date Release_2 = new Date();
	...
	private final static Date Release_3 = new Date();
	...
	private final static Date Release_4 = new Date();
